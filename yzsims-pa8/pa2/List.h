...
// ID: yzsims
// Title: List.h
// Description: Header file for List ADT (Programming Assignment 1)
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#include <stdbool.h>
#include <stdio.h>
...
#define FORMAT "%d"	//formate string for ListElement
...
void freeList(List* pL); 	// Frees all heap memory associated with *pL, sets *pL to NULL.
...
bool equals(List A, List B); 	// Returns true iff Lists A and B are in same state
